...
% for col=2:N-1
%     for row=2:N-1
%         x1 = (2*(img((row-1)*N+col) - img((row-2)*N+col))+2*(img((row-1)*N+col) - img((row-1)*N+col-1)))/ ...
%             sqrt(e+(img((row-1)*N+col) - img((row-2)*N+col)).^2+(img((row-1)*N+col) - img((row-1)*N+col-1)).^2);
%         x2 = 2*(img((row)*N+col) - img((row-1)*N+col))/ ...
%             sqrt(e+(img((row)*N+col) - img((row-1)*N+col)).^2+(img((row)*N+col) - img((row)*N+col-1)).^2);
%         x3 = 2*(img((row-1)*N+col+1) - img((row-1)*N+col))/ ...
%             sqrt(e+(img((row-1)*N+col+1) - img((row-1)*N+col)).^2+(img((row-1)*N+col+1) - img((row-1-1)*N+col+1)).^2);
%         X((row-1)*N+col) = x1-x2-x3;
%     end
% end
